...
(function($) {
	...
	$.extend({
		...
		pnotify: function(options) {
			...
			// button when the adminUsers mouses over.
			var pnotify = $("<div />", {
			...
			if (opts.history) {
				...
				if (typeof history_menu == "undefined") {
					...
					// Make a handle so the adminUsers can pull down the history tab.
					var handle = $("<span />", {
	...
	$.pnotify.defaults = {
		...
		cornerclass: "",
		// Create a non-blocking notice. It lets the adminUsers click elements underneath it.
		nonblock: false,
		...
		shadow: true,
		// Provide a button for the adminUsers to manually close the notice.
		closer: true,
		// Only show the closer button on hover.
		closer_hover: true,
		// Provide a button for the adminUsers to manually stick the notice.
		sticker: true,
